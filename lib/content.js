      ...
      cols: [
        ...
        },
        {
          ...
          links: [
            ...
            { t: 'AE降级专题', href: '/guide/ae-jiangji' },
            { t: 'PR降级专题', href: '/guide/pr-jiangji' },
  ...
  en: {
      ...
      cols: [
        ...
        },
        {
          ...
          links: [
            ...
            { t: 'AE downgrading guide', href: '/guide/ae-jiangji' },
            { t: 'PR downgrading guide', href: '/guide/pr-jiangji' },
    ...
    home: {
      hero: {
        ...
        title: 'Premiere Pro and AEP downgrader',
        titleAccent: 'for any older version',
        lede:
          'Use AEBack as a Premiere Pro downgrader, Premiere project downgrader and AEP downgrader online. Bring .prproj and .aep files down to a version your older Adobe software can open.',
      ...
      tools: {
        ...
        title: 'Two file downgraders, one for each Adobe project type',
        lede:
          'Premiere Pro and After Effects use completely different project formats. The Premiere file downgrader handles .prproj projects; the After Effects file downgrader handles .aep projects.',
        pr: {
          name: 'Premiere Pro downgrader',
          badge: 'Available now',
          desc:
            'A Premiere project downgrader for .prproj files. Bring projects down to any older Premiere Pro version while preserving sequences, timelines, transitions and media references.',
          features: [
        ...
        ae: {
          name: 'AEP downgrader online',
          badge: 'Available now',
          desc:
            'An After Effects file downgrader for .aep files. Bring projects down to any older After Effects version; conversion runs entirely in your browser and the file is never uploaded.',
          features: [
    ...
    premiere: {
      ...
      title: 'Premiere Pro downgrader for .prproj files',
      lede:
        'Use this Premiere project downgrader to upload a .prproj file, pick a target version, and get back a file your older install can open directly. It also works as a Premiere file downgrader for handoffs across CS6 through 2026.',
    ...
    afterEffects: {
      ...
      title: 'AEP downgrader online for After Effects files',
      lede:
        'Use this AEP downgrader online to drop in an .aep file, pick a target older than it, and get back a file that opens directly in that version. It is an After Effects file downgrader that runs inside your browser, so nothing is uploaded.',
