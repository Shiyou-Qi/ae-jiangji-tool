...
export const CORE_PAGES = {
  home: {
    ...
    en: {
      title: 'AEBack · Premiere Pro downgrader and AEP downgrader online',
      desc: 'Use AEBack as a Premiere Pro downgrader, Premiere project downgrader and AEP downgrader online. Convert .prproj and .aep files for older Adobe apps.',
      keys: [
  ...
  premiere: {
    ...
    en: {
      title: 'Premiere Pro downgrader — Premiere project and file downgrader',
      desc: 'A free Premiere Pro downgrader for .prproj files. Use it as a Premiere project downgrader or Premiere file downgrader across CS6 through 2026.',
      keys: [
        'Premiere Pro downgrader',
        'premiere project downgrader',
        'premiere file downgrader',
  ...
  afterEffects: {
    ...
    en: {
      title: 'AEP downgrader online — After Effects file downgrader',
      desc: 'A free AEP downgrader online for After Effects project files. Use the After Effects file downgrader to lower .aep projects to AE 2018–2026.',
      keys: [
        'AEP downgrader',
        'AEP downgrader online',
        'aep-downgrader',
